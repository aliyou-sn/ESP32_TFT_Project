...
lv_obj_set_width( ui_GrillSwitch, 155);
lv_obj_set_height( ui_GrillSwitch, 80);
lv_obj_set_x( ui_GrillSwitch, -58 );
lv_obj_set_y( ui_GrillSwitch, -54 );
...
lv_obj_set_width( ui_Switch2, 155);
lv_obj_set_height( ui_Switch2, 80);
...
lv_obj_set_width( ui_GrillIndicator, 65);
lv_obj_set_height( ui_GrillIndicator, 65);
lv_obj_set_x( ui_GrillIndicator, -95 );
lv_obj_set_y( ui_GrillIndicator, -53 );
...
lv_obj_set_width( ui_WarmerIndicator, 65);
lv_obj_set_height( ui_WarmerIndicator, 65);
lv_obj_set_x( ui_WarmerIndicator, -95 );
lv_obj_set_y( ui_WarmerIndicator, 39 );
